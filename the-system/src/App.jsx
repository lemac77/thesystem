...
// ─── DASHBOARD ───────────────────────────────────────────────────────────────
const Dashboard = ({clients,leads,quests,tasks,workoutLog,dietLog,moodLog,goals,payments,onWeeklyReview}) => {
    ...
    <div className="app-shell" style={{minHeight:"100dvh",background:C.bg,color:C.text,fontSize:window.innerWidth>1400?"20px":window.innerWidth>1100?"18px":window.innerWidth>768?"16px":"14px"}}>
      ...
      <div style={{padding:"96px clamp(14px,4vw,60px) 50px",maxWidth:860,margin:"0 auto"}}>
        {!loaded ? (
          ...
          <>
            {tab==="dashboard" && <Dashboard clients={clients} leads={leads} quests={quests} tasks={tasks} workoutLog={workoutLog} dietLog={dietLog} moodLog={moodLog} goals={goals} payments={payments} onWeeklyReview={generateWeeklyReport}/>}
