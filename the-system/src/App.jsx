  ...
  return (
    <Modal title="Quest Failed — Penalty" onClose={onClose}>
      <div style={{textAlign:"center",padding:"8px 0 4px"}}>
        ...
        <Card style={{marginBottom:14,textAlign:"left"}}><div style={{fontFamily:"'Share Tech Mono',monospace",fontSize:16,color:C.text}}>"{quest.text}"</div></Card>
        <Card glow style={{marginBottom:18,padding:"20px 16px"}}>
          ...
          <div style={{fontFamily:"'Share Tech Mono',monospace",fontSize:15,color:C.textDim,marginTop:8}}>// execute now. no exceptions.</div>
        </Card>
        {!done
...
const Dashboard = ({clients,leads,quests,tasks,workoutLog,dietLog,moodLog,goals,payments}) => {
  ...
  return (
    <div className="fi">
      ...
      <div style={{fontFamily:"'Share Tech Mono',monospace",fontSize:15,color:C.textMuted,marginBottom:16,letterSpacing:"0.1em"}}>
      ...
      <Section title="Diet Tracker">
        ...
        <Grid cols={2} gap={8} style={{marginBottom:16}}>
          <Card style={{textAlign:"center",padding:"16px 8px"}}>
            ...
            <div style={{fontFamily:"'Rajdhani',sans-serif",fontSize:15,color:C.textDim,letterSpacing:"0.12em",textTransform:"uppercase",marginTop:5}}>Giorni clean</div>
          </Card>
          <Card style={{textAlign:"center",padding:"16px 8px"}}>
            <div style={{fontFamily:"'Cinzel',serif",fontSize:34,color:bad7>2?C.danger:C.gold,fontWeight:700,lineHeight:1}}>{bad7}</div>
            <div style={{fontFamily:"'Rajdhani',sans-serif",fontSize:15,color:C.textDim,letterSpacing:"0.12em",textTransform:"uppercase",marginTop:5}}>Sgarri 7gg</div>
          </Card>
        </Grid>
        ...
        <Card>
          ...
          <Row gap={5} style={{justifyContent:"space-between",marginTop:8}}>
            {last7.map(({k,d,log})=>(
              <div key={k} style={{flex:1,textAlign:"center"}}>
                <div style={{fontFamily:"'Share Tech Mono',monospace",fontSize:16,color:C.textMuted,marginBottom:6}}>{d}</div>
                ...
                <Row style={{justifyContent:"space-between",marginBottom:10}}>
                  <Row gap={10}>
                    ...
                    <div>
                      ...
                      <div style={{fontFamily:"'Share Tech Mono',monospace",fontSize:15,color:C.textDim}}>🔥 {streak}d streak</div>
                    </div>
                  </Row>
                  <Row gap={8}>
                    <div style={{fontFamily:"'Share Tech Mono',monospace",fontSize:16,color:done?C.success:C.textDim}}>{todayVal}/{h.target} {h.unit}</div>
