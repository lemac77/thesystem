...
export default function App() {
  ...
  return (
    <div className="app-shell" style={{minHeight:"100dvh",background:C.bg,color:C.text}}>
      <GS/>
      <div style={{position:"fixed",top:0,left:0,right:0,width:"100%",zIndex:50,background:C.bg,borderBottom:`1px solid ${C.border}`}}>
      ...
      <div style={{padding:"96px clamp(16px,5vw,80px) 50px",maxWidth:1100,margin:"0 auto"}}>
        {!loaded ? (
