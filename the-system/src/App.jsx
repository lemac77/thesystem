      ...
      if(getSB()){
        ...
        try {
          ...
          if(data){
            ...
            if(data.smokeLog&&Object.keys(data.smokeLog).length) setSmokeLog(data.smokeLog);
            if(data.focusLog&&Object.keys(data.focusLog).length) setFocusLog(data.focusLog);
...
{"quests":["testo quest 1","testo quest 2","testo quest 3"]}`;
  ...
  stateRef.current = {clients,leads,quests,tasks,ideas,goals,notes,payments,workoutLog,dietLog,moodLog,weightLog,habitLog,habits,slotDays,slotStart,apiKeys,smokeLog,focusLog};
  useEffect(()=>{
