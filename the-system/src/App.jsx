  ...
  <style>{`
    ...
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    @media(min-width:900px){
      .fi{display:grid;grid-template-columns:1fr 1fr;gap:24px;align-items:start;}
      .fi > *{min-width:0;}
      .fi-full{grid-column:1/-1!important;}
    }
  `}</style>
);
...
export default function App() {
  ...
  return (
    <div className="app-shell" style={{minHeight:"100dvh",background:C.bg,color:C.text}}>
      ...
      <div style={{padding:"96px clamp(14px,4vw,60px) 50px"}}>
        {!loaded ? (
