...
const DB = {
  upsert: async (table, rows) => {
    ...
    await sbReqAuth(table+"?on_conflict=id", {method:"POST", prefer:"return=minimal", headers:{"Prefer":"resolution=merge-duplicates,return=minimal"}, body:JSON.stringify(rows.map(r=>({...r,user_id:getUID()})))});
  },
